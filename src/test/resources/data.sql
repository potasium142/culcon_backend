...
values ('example@test996d4a65-9561-47d3-8fc2-31a5868dad52',
        ...
        1, null,
        'test_account');
insert into PUBLIC.ACCOUNT (ID, ADDRESS, BOOKMARKED_POSTS, EMAIL, PASSWORD, PHONE, PROFILE_DESCRIPTION, PROFILE_PIC_URI,
                            STATUS, TOKEN, USERNAME)
values ('c75265e6-f5cc-419b-b183-7b43dbb9f27b', 'mei mei', '', 'trinhquangtung1@gmail.com',
        '$2a$10$eiP6w0So6payU/vsjmShCeoPOugB7mfdG2cZII3CKcrFSViHBO.ze', '0111111114', 'yummi',
        'http://res.cloudinary.com/dolsfyjf7/image/upload/v1733998854/pfp_c75265e6-f5cc-419b-b183-7b43dbb9f27b.jpg', 1,
       ...
       ('5239ecbf-5985-41b5-bcf1-ca91c9f02995', 'mei mei', '', 'trinhquangtung3105@gmail.com',
        '$2a$10$DgCD4WjIwt3zaw6d.s4V7eVbdtIBOWRu4qCxmddKMrdZwSasU5x/G', '0981965778', null, 'defaultProfile', 1,
       ...
       ('94511231-59ce-45cb-9edc-196c378064a1', '69, Sussy town', '', 'test@email.com',
        '$2a$10$Z29kmHZUDNjSdqL4UMLzy.wNaSHneqI7NA53GEC1C1te2UBrFRso6', '0123456789', 'le sus', 'defaultProfile', 1,
       ...
       ('4941b73e-9609-46b5-9059-d62a37c5238c', '', '', 'example@admin0',
        '$2a$10$n7NTAk2ymn6sYQEmwnqbI.mIqOBFSAWdXoZewi.PiPxQqnZiQq9zq', '0123456799', '', 'defaultProfile', 1, null,
        'admin');
...
values (2, '94511231-59ce-45cb-9edc-196c378064a1', 'trinhquangtung3105@gmail.com', 'Rgy8YTrwELqlh1',
       ...
       (4, 'c75265e6-f5cc-419b-b183-7b43dbb9f27b', 'trinhquangtung1@gmail.com', 'EO7XNGL45etGE4',
        '2025-12-13 11:54:27.629172', null);
...
values (102, '2024-12-12 21:47:26.237815', '69, Sussy town', '', 0, 0, 0, '0123456789', 'test3', 22.5, null,
       ...
       (153, '2024-12-13 01:25:22.196430', '69, Sussy town', '', 0, 0, 0, '0123456789', 'test3', 11.25, null,
        '94511231-59ce-45cb-9edc-196c378064a1'),
       (202, '2024-12-13 01:30:12.698704', '69, Sussy town', '', 0, 0, 0, '123456789', 'test3', 22.5, null,
        '94511231-59ce-45cb-9edc-196c378064a1');
